...
defbindings("WMPlex.toplevel", {
    ...
    kpress(META.."F4", "notioncore.exec_on(_, 'autorandr --match-edid -l default')"),
...
defbindings("WFrame", {
    ...
    kpress(ALTSHIFT.."Tab", "WFrame.switch_prev(_)"),
...
defbindings("WMoveresMode", {
    ...
    bdoc("Alter left border"),
    kpress("Shift+F",     "WMoveresMode.resize(_, 1, 0, 0, 0)"),
    kpress("Shift+B",     "WMoveresMode.resize(_,-1, 0, 0, 0)"),
    kpress("Shift+Left",  "WMoveresMode.resize(_, 1, 0, 0, 0)"),
    kpress("Shift+Right", "WMoveresMode.resize(_,-1, 0, 0, 0)"),

    bdoc("Alter right border"),
    kpress("F",     "WMoveresMode.resize(_, 0,-1, 0, 0)"),
    kpress("B",     "WMoveresMode.resize(_, 0, 1, 0, 0)"),
    kpress("Left",  "WMoveresMode.resize(_, 0,-1, 0, 0)"),
    kpress("Right", "WMoveresMode.resize(_, 0, 1, 0, 0)"),

    bdoc("Alter top border"),
    kpress("Shift+P",    "WMoveresMode.resize(_, 0, 0, 1, 0)"),
    kpress("Shift+N",    "WMoveresMode.resize(_, 0, 0,-1, 0)"),
    kpress("Shift+Up",   "WMoveresMode.resize(_, 0, 0, 1, 0)"),
    kpress("Shift+Down", "WMoveresMode.resize(_, 0, 0,-1, 0)"),

    bdoc("Alter bottom border"),
    kpress("P",    "WMoveresMode.resize(_, 0, 0, 0,-1)"),
    kpress("N",    "WMoveresMode.resize(_, 0, 0, 0, 1)"),
    kpress("Up",   "WMoveresMode.resize(_, 0, 0, 0,-1)"),
